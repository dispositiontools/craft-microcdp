...
use dispositiontools\microcdp\assetbundles\cdpactionswidget\CdpActionsWidgetAsset;
 ...
 * @since     1.0.0
 */
class CdpActions extends Widget
{
    ...
    {
        return Craft::t('micro-cdp', 'CdpActions');
    }
    ...
    {
        return Craft::getAlias("@dispositiontools/microcdp/assetbundles/cdpactionswidget/dist/img/CdpActions-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'micro-cdp/_components/widgets/CdpActions_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CdpActionsWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'micro-cdp/_components/widgets/CdpActions_body',
            [
