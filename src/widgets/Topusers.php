...
use dispositiontools\microcdp\assetbundles\topuserswidget\TopusersWidgetAsset;
...
class Topusers extends Widget
{
    ...
    {
        return Craft::t('micro-cdp', 'Topusers');
    }
    ...
    {
        return Craft::getAlias("@dispositiontools/microcdp/assetbundles/topuserswidget/dist/img/Topusers-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'micro-cdp/_components/widgets/Topusers_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(TopusersWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'micro-cdp/_components/widgets/Topusers_body',
            [
