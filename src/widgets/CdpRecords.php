...
namespace dispositiontools\microcdp\widgets;

use dispositiontools\microcdp\MicroCDP;
use dispositiontools\microcdp\assetbundles\cdprecordswidget\CdpRecordsWidgetAsset;
 ...
 * @since     1.0.0
 */
class CdpRecords extends Widget
{
    ...
    {
        return Craft::t('micro-cdp', 'CdpRecords');
    }
    ...
    {
        return Craft::getAlias("@dispositiontools/microcdp/assetbundles/cdprecordswidget/dist/img/CdpRecords-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'micro-cdp/_components/widgets/CdpRecords_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CdpRecordsWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'micro-cdp/_components/widgets/CdpRecords_body',
            [
