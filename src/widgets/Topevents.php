...
use dispositiontools\microcdp\assetbundles\topeventswidget\TopeventsWidgetAsset;
 ...
 * @since     1.0.0
 */
class Topevents extends Widget
{
    ...
    {
        return Craft::t('micro-cdp', 'Topevents');
    }
    ...
    {
        return Craft::getAlias("@dispositiontools/microcdp/assetbundles/topeventswidget/dist/img/Topevents-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'micro-cdp/_components/widgets/Topevents_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(TopeventsWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'micro-cdp/_components/widgets/Topevents_body',
            [
